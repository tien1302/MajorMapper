...
namespace BAL.Services.Implementations
{
    public class ScoreService : IScoreService
    {
        ...
        public ScoreService(IScoreRepository scoreRepository, IPersonalityTypeRepository personalityTypeRepository, ITestResultRepository testResultRepository, IMapper mapper)
        {
